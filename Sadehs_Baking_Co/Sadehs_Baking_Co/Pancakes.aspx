<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Pancakes.aspx.cs" Inherits="Sadehs_Baking_Co.Pancakes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="conainer_3">
         <h1 style="text-align:center; font-size:50px; ">פנקייקס</h1>
        <p style="text-align:center; top:-20px;">
            <img src="pics/pancakes header.jpg" class="imgHead" /></p>
        <br />
        <p class="ingridients">
            <img src="pics/pancakes gif.gif" style="position:relative; top:600px; right:350px; width:825px; border-radius:12px;"/><br />
           מצרכים<br /><br />
