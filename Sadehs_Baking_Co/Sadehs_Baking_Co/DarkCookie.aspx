<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DarkCookie.aspx.cs" Inherits="Sadehs_Baking_Co.DarkCookie" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="conainer_3">
         <h1 style="text-align:center; font-size:50px; ">עוגיות שוקולד</h1>
        <p style="text-align:center; top:-20px;">
            <img src="pics/darkle.jpg" class="imgHead" /></p>
        <br />
        <p class="ingridients">
            <img src="pics/darkle gif.gif" style="position:relative; top:600px; right:350px; width:825px; border-radius:12px;"/><br />
           מצרכים<br /><br />
